...
c      WR=-WND*TAN(RANGL)
      ...
      WM=SQRT(WX**2+WY**2)
cRMY START CD TRUNCATION!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
c      IF(WM.LT.10.) CD=1.14*1.E-3
c      IF(WM.GE.10.) CD=(0.49+.065*WM)*1.E-3
      G0CD=9.80665
      VKCD=0.4
      WM=0.9*WM
      IF(WM.LE.12.5) Z0CD=0.0185/G0CD*(0.007*WM*WM+0.0328*WM-0.0137)**2.
      IF(WM.GE.12.5) Z0CD=(0.085*WM-0.58)*1.E-3
      CD=VKCD*VKCD/((ALOG(10./Z0CD))**2.)
cRMY END CD TRUNCATION!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      IF(WM.LE.35.) then
