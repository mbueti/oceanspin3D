...
C   UNIT   21    sst.avn.dat file, contains ascii SST data
C   UNIT   22    mask.avn.dat file, contains ascii AVN landsea mask data
C   UNIT   23    gfdl_avn_latlon_t170 (lons & lats for AVN 512x256 T170)
C
C OUTPUT FILES:
...
cRMY      call w3tagb('GFDL_OCEAN.WESTATL',2001,0082,0003,'NP22')
...
c-------------- falk 01-05-04 write param. for avrtau
...
cRMY      call w3tage('GFDL_OCEAN.WESTATL')
